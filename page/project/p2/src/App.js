...
class App extends Component {
  ...
  filters() {
    ...
    const filterComponents = _(filters).keys().map((type) => {
      ...
      return (
        <SelectField
          ...
          style={this.state.styles.search.filter}
          autoWidth={true}
        >
    ...
    filterComponents.push((
      <FlatButton
        key="clear-filters"
        style={this.state.styles.search.button}
        label="Clear Filters"
  ...
  render() {
    return (
      <div className="App">
        <div style={this.state.styles.search.container}>
          <AppBar style={this.state.styles.search.background} showMenuIconButton={false}/>
          <CustomSearchBar
            ...
            style={this.state.styles.search.bar}
          />
        </div>
        <div style={this.state.styles.resultsContainer}>
          <ResultDisplay
